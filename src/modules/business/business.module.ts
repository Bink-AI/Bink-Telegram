...
@Module({
  ...
  providers: [
    ...services,
    {
      ...
      useFactory: () => {
        const rpc = process.env.RPC_URL || 'https://mainnet.solana.com';
    ...
    },
    {
      ...
      useFactory: () => {
        const rpc = process.env.ETHEREUM_RPC_URL || 'https://eth-mainnet.g.alchemy.com/v2/demo';
        return new ethers.JsonRpcProvider(rpc);
      },
    },
    {
